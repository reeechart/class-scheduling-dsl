...
public class Main {
    public static void main(String[] args) {
        ...
        Lecture lecture = new Lecture("IF4019", 30);
        lecture.addFacility("ac");
        lecture.setLecturer(lecturer);

        Lecture lecture2 = new Lecture("IF4029", 30);
        lecture2.addFacility("proyektor");
        lecture2.setLecturer(lecturer);

        Constraint const1 = new Constraint("IF4019", "IF4029");
        Classroom classroom = new Classroom("7602", 40, new ArrayList<>(3 ));
        ...
        ArrayList<Classroom> result = scheduler.findClassrooms(lecture);
        itr = result.iterator();
        while(itr.hasNext()) {
            Classroom a = (Classroom)itr.next();
            a.printClassroom();
        }
    }
}
